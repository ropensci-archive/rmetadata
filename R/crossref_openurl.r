...
#' @examples \dontrun{
#' crossref_openurl(doi="10.1371/journal.pone.0042793")
#' print(crossref_openurl("10.3998/3336451.0009.101"), style="Bibtex")
#' print(crossref_openurl("10.3998/3336451.0009.101"), style="text")
#' }
#' @export
crossref_openurl <- function(doi, title = FALSE, key = "cboettig@gmail.com", ..., curl = getCurlHandle())
{
